...
function SearchDocumentComponent({ showModalSearchDocument, setShowModalSearchDocument, logged, selectSpecificDocument }) {
	...
	const [currentTipoDocumento, setCurrentTipoDocumento] = useState(2);
				...
				return (
					<>
						...
						<Button
							type='primary'
							size='middle'
							onClick={() => alert('No tiene un tipo de impresión.')}
						>
							<PrinterOutlined />
						</Button>
						<Button
		...
		>
			<Form form={form} layout='vertical'>
				<Row gutter={24}>
					...
					<Col span={12}>
						<Form.Item name="documento_interno" label="Número documento interno">
							<Input
					...
					<Col span={12}>
						<Form.Item name="proveedor_id" label="Proveddor">
							<Select
								showSearch
								style={{ width: '100%', marginBottom: '12px' }}
								name="proveedor_id"
					...
					<Col span={24}>
						<Form.Item name="tipo_documento_id" label="Tipo documento">
							<Select
								...
								defaultValue={currentTipoDocumento}
							>
								{

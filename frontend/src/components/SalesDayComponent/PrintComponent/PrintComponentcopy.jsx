...
function PrintComponent({ 
	...
	const { printScreen, multiPrinters, activateDiscount, activatePaymentType, onProporcion, setOnProporcion } = useActivations(logged);
	...
	const onSubmit = async () => {
		...
		if(typeDocument === 9 && currentDocument.cliente_id !== 1 && onProporcion) {
			typeDocument = 10;
